...
Revision ID: ec2e2ef2c8dc
Revises: bf2e59dd41be
Create Date: 2025-04-27 19:15:38.413004
...
revision: str = 'ec2e2ef2c8dc'
down_revision: Union[str, None] = 'bf2e59dd41be'
...
def upgrade() -> None:
    ...
    op.drop_table('collection_768_2')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('collection_768_2',
    ...
    sa.PrimaryKeyConstraint('id', name='collection_768_2_pkey')
    )
